                ...
                <div class="col-12 data_tables">
                                    ...
                                    <div class="button_section_align">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-sm-12 m-t-15 text-right">
                                                <form method="POST" action="{{ route('errors.search') }}">
                                                @csrf
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <i class="fa fa-table"></i> Error Logs {{ isset($title) ? $title:'' }}
                        </div>
                        <div class="card-body m-t-35">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped my-4 w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            <td> {{ $error->created_at->toDayDateTimeString() }}</td>
                            ...
                            <div style="text-align: right; width:100%;">{{ $errors->links() }}</div>
