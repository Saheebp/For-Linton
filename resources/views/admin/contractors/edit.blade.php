                    ...
                    <div class="card m-t-35">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-lg-10">
                                    <form class="form-horizontal" method="POST" action="{{ route('customers.update', auth()->user()->id) }}">
                                        {{ method_field('PATCH') }}
                                        @csrf
                                        <fieldset>
                                            <!-- Name input-->
                                             ...
                                             <div class="form-group row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="input-group input-group-prepend">
                                                        ...
                                                        <input type="text" class="form-control" id="phone" placeholder="Phone Number" name="phone" value="{{ $user->mat_number }}">
                                                    </div>
                                                </div>
                                            </div>
