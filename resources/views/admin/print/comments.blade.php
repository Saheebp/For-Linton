...
<head>
  ...
  <body style="margin-top:0px; font-size:20px;";>
    ...
    <div style="padding:20px; padding-bottom:15px;">
        ...
        <h3 align="center" style="text-transform:uppercase;">PROJECT COMMENTS REPORT</h3>
        <div class="row">
        ...
        <hr width="100%">
        <h4 align="left" style="text-transform:uppercase;">Comments</h4>
        <div class="row">
            <table border="0" cellspacing="0" width="100%" style="margin-top:0px; text-align:left;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ date('d M Y, h:ia', strtotime($comment->created_at)) }}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
