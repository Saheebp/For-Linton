...
<head>
  ...
  <body style="margin-top:0px; font-size:20px;";>
    ...
    <div style="padding:20px; padding-bottom:15px;">
        ...
        <h3 align="center" style="text-transform:uppercase;">PROJECT TASK REPORT</h3>
        <div class="row">
            ...
            <table border="0" cellspacing="0" width="100%" style="margin-top:0px;">
                <tbody>
                    ...
                    <tr>
                        <td>
                        <hr width="100%">
                            <b style="color:green;">Task {{$i}}</b><br> 
                            <b>Title : </b>{{ $task->name ?? '' }}<br> 
                            <b>Description : </b>{{ $task->description ?? '' }}<br> 
                            @if ($task->subtasks->count() != 0)
                                <h5 align="left" style="text-transform:uppercase;">Sub Tasks</h5>
                                <table border="0" cellspacing="0" width="100%" style="margin-top:0px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ $subtask->actual_cost ?? 'N/A' }}
                                            </td>
                                        </tr> 
                                        <tr>
                                            <td colspan="4">
                                                <b>Description : </b>{{ $subtask->description ?? '' }}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
