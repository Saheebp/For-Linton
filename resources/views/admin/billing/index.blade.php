                                        ...
                                        <div class="col-12 col-sm-6 col-xl-3">
                                            <div id="top_widget1">
                                                <div class="">
                                                    <div class="bg-white b_r_5 section_border">
                                                        <div class="p-t-l-r-15">
                                                            <div id="widget_countup12" style="font-size:24px;">&#8358;{{ number_format(floatval($card), 2) }}</div>
                                        ...
                                        <div class="col-12 col-sm-6 col-xl-3">
                                            <div id="top_widget1">
                                                <div class="">
                                                    <div class="bg-white b_r_5 section_border">
                                                        <div class="p-t-l-r-15">
                                                            <div id="widget_countup12" style="font-size:24px;">&#8358;{{ number_format(floatval($bank_transfer), 2) }}</div>
