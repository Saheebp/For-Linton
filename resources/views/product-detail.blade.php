                                ...
                                <div class="ltn__shop-details-img-gallery ltn__shop-details-img-gallery-2">
                                    <div class="ltn__shop-details-small-img slick-arrow-2">
                                        <div class="single-small-img">
                                            <img src="{{ asset('frontend/img/product/7.png') }}" alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{ asset('frontend/img/product/7.png') }}" alt="Image">
                                        </div>
                                    ...
                                    <div class="ltn__shop-details-large-img">
                                        <div class="single-large-img">
                                            <a href="{{ asset('frontend/img/product/7.png') }}" data-rel="lightcase:myCollection">
                                                <img src="{{ asset('frontend/img/product/7.png') }}" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                ...
                                <div class="modal-product-info shop-details-info pl-0">
                                    ...
                                    <div class="ltn__product-details-menu-2 product-cart-wishlist-btn mb-30">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#" class="btn btn-effect-1 d-add-to-wishlist" title="Add to Cart" data-toggle="modal" data-target="#add_to_cart_modal">
        ...
        <div class="container">
            ...
            <div class="row ltn__related-product-slider-one-active slick-arrow-1">
                ...
                <div class="col-12">
                    <div class="ltn__product-item ltn__product-item-4">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="{{ route('product.detail',  [1]) }}">Pink Flower Tree</a></h2>
                            <div class="product-price">
                                <span>&#8358;18.00</span>
                                <del>&#8358;21.00</del>
                            </div>
                ...
                <div class="col-12">
                    <div class="ltn__product-item ltn__product-item-4">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="{{ route('product.detail',  [1]) }}">Premium Joyful</a></h2>
                            <div class="product-price">
                                <span>&#8358;18.00</span>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="ltn__product-item ltn__product-item-4">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="{{ route('product.detail',  [1]) }}">The White Rose</a></h2>
                            <div class="product-price">
                                <span>&#8358;16.00</span>
                                <del>&#8358;19.00</del>
                            </div>
                ...
                <div class="col-12">
                    <div class="ltn__product-item ltn__product-item-4">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="{{ route('product.detail',  [1]) }}">Red Rose Bouquet</a></h2>
                            <div class="product-price">
                                <span>&#8358;20.00</span>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="ltn__product-item ltn__product-item-4">
                        <div class="product-img">
                            <a href="{{ route('product.detail',  [1]) }}"><img src="img/product/12.png" alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="badge-1">Hot</li>
                                </ul>
