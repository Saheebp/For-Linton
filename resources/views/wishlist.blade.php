                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="cart-product-image">
                                            <a href="{{ route('product.detail', [1]) }}"><img src="img/product/1.png" alt="#"></a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="cart-product-remove">x</td>
                                        <td class="cart-product-image">
                                            <a href="{{ route('product.detail',  [1]) }}"><img src="img/product/2.png" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
                                    ...
                                    <tr>
                                        <td class="cart-product-remove">x</td>
                                        <td class="cart-product-image">
                                            <a href="{{ route('product.detail',  [1]) }}"><img src="img/product/4.png" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
