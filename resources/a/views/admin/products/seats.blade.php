            ...
            <div class="row">
                <div class="col-12 data_tables">
                    ...
                    <div class="card-header bg-white">
                        <i class="fa fa-table"></i>Booking Information
                    </div>
                        ...
                        <div class="row">
                            ...
                            <table id="example1" class="display table table-stripped table-bordered">
                                <tbody>
                                    ...
                                    <tr><td><b>Type: </b></td><td class="text-capitalize">{{ $trip->tripType->name }}</td></tr>
                                    ...
                                    <tr><td><b>Passengers: </b></td><td>{{ $passenger_names }}</td></tr>
                                    <tr><td><b>No of Seats: </b></td><td>{{ $noofseats }} seat(s)</td></tr>
                                    <tr><td><b>Amount To Pay: </b></td><td class="text-success">&#8358;{{ number_format(floatval($amount), 2) }} </td></tr>
                                </tbody>
                            </table>
                            </div>
                            ...
                            <div class="col-lg-4 pb-3 col-sm-12 mt-5 mb-5">
                                ...
                                <table id="example1" width="50%" class="display table table-stripped table-bordered">
                                    <form action="{{ route('admin.booking.preview') }}" method="POST">
                                    @csrf
                                        ...
                                        <input type="hidden" name="userdetails" value="{{ $userdetails }}">
                                        ...
                                        <div class="text-left m-2">
                                            @if($trip->tripType->name == 'regular')
                                                <table align="center" width="100px" height="" style="
                                        ...
                                        <div class="text-left pl-5 pl-sm-5 col-12 mt-3">
                                            <input type="checkbox" name="tandc" required checked/> <tag>I have read and agree to the <a class="text-danger" data-toggle="modal" data-target="#termsandcond">terms and conditions</a> of service</tag>
                                        </div>
                                        ...
                                        <div class="text-left pl-5 pl-sm-5 col-12 mt-3">
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group col-12">
                                                    Payment Method
                                                    <select name="payment_method" class="form-control p-0 pb-0" required>
                                                        <option value="">-- Select --</option>
                                                        <option value="transfer">Pay via Transfer</option>
                                                        <option value="cash">Pay with Cash</option>
                                                        <!-- <option value="card">Pay with Card (Paystack)</option> -->
                                                    </select>
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-md btn-success mt-1 mb-3">Record Payment</button>
                                            <p class="text-italicize">Note: <br>Recording payment implies that the booking fare has been successfully received from the customer</p>
